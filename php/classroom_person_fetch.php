...
/* Create an active/current tablink class */
	...
	<div class="tab">
    <a href="./course_details.php?course_code=<?php echo $couse_code;?>"><button class="tablinks" >Course stream</button>
		<a href="./classroom_person_fetch.php?course_code=<?php echo $couse_code;?>"><button class="tablinks" style="color: #ddbdfc;">People (<?php echo $no_persons;?>)</button></a>
	</div>
