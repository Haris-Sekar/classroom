						...
						<div class="inner">
							...
							<!-- Logo -->
								<a href="student_home.php" class="logo">
									<span class="symbol"><img src="../images/logo.svg" alt="" /></span><span class="title">Classroom Student area</span>
								</a>
				...
				<!-- Menu -->
					<nav id="menu">
						...
						<ul>
                           ...
                           ?>
							<li><a href="course_details.php?course_code=<?php echo $row['course_code'];?>"><?php echo $row2['course_name'].'-'.$row2['class_name'] ?></a></li>
							<?php } ?>
						</ul>
					</nav>
